...
mod service_example_tests {
    ...
    fn get_targets_with_salary_home_office(period: &dyn IPeriod) -> ArcTermTargetList {
        ...
        vec![
            ...
            Arc::new(ExampleTermTarget::zero_value(&mont_code, &contract, &position, &variant1,
                                                   &ArticleCode::get(ExampleArticleConst::ArticleAllowceHoffice as i32),
                                                   &ConceptCode::get(ExampleConceptConst::ConceptAmountFixed as i32))),
        ]
    }
    #[test]
    fn example_salary_home_office() {
        ...
        let rest_targets = get_targets_with_salary_home_office(&test_period);
        ...
        let test_articles = [80001, 80005, 80002, 80006, 80007, 80010, 80012, 80008, 80009, 80011, 80013];
